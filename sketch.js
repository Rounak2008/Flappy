...
function spawnObstacles() {
  ...
  if (frameCount % 60 === 0) {
    var ob1 = createSprite(1550,500,40,10);
    ob1.addImage(ob1Img);
    ob1.scale = 0.5;
    ob1.velocityX = -3;

    var ob2 = createSprite(1650,200,40,10);
    ob2.addImage(ob2Img);
    ob2.scale = 0.5;
    ob2.velocityX = -3;

    var ob3 = createSprite(1750,480,40,10);
    ob3.addImage(ob3Img);
    ob3.scale = 0.5;
    ob3.velocityX = -3;

    var ob4 = createSprite(1850,200,40,10);
    ob4.addImage(ob4Img);
    ob4.scale = 2;
    ob4.velocityX = -3;

    var ob5 = createSprite(1950,200,40,10);
    ob5.addImage(ob5Img);
    ob5.scale = 2;
    ob5.velocityX = -3;

    var ob6 = createSprite(2050,580,40,10);
    ob6.addImage(ob6Img);
    ob6.scale = 2;
    ob6.velocityX = -3;

    var ob7 = createSprite(2150,560,80,10);
    ob7.addImage(ob7Img);
    ob7.scale = 2;
    ob7.velocityX = -3;  
 
    var ob8 = createSprite(2250,555,40,10);
    ob8.addImage(ob8Img);
    ob8.scale = 1.2;
    ob8.velocityX = -3;

    var ob9 = createSprite(2350,150,40,10);
    ob9.addImage(ob9Img);
    ob9.scale = 1.1;
    ob9.velocityX = -3;

    var ob10 = createSprite(2450,550,40,10);
    ob10.addImage(ob10Img);
    ob10.scale = 1.2;
    ob10.VelocityX = -3;

    var ob11 = createSprite(2550,200,45,10);
    ob11.addImage(ob11Img);
    ob11.scale = 1.8;
    ob11.velocityX = -3;

    var ob12 = createSprite(2650,250,60,10);
    ob12.addImage(ob12Img);
    ob12.scale = 1.8;
    ob12.velocityX = -3;

    var ob13 = createSprite(2750,520,40,10);
